...
@st.cache_data
def load_data():
    df = pd.read_csv(r"C:\DSIP\mandi_prices_karnataka_daily(1).csv")
...
location_data = pd.read_csv(r"C:\DSIP\karnataka_district_mandis2.csv")
...
buyers_df = pd.read_csv(r"C:\DSIP\karnataka_crop_buyers.csv")
